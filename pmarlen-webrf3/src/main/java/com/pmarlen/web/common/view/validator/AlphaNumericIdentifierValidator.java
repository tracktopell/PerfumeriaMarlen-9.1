...
public class AlphaNumericIdentifierValidator implements Validator {
	
	private static final String REG_EXP_ALPHANUMBER_PATTERN = "^([A-Za-z][0-9a-zA-Z\\.]+[0-9a-zA-Z])$";
	
	public static final String ALPHANUMBER_FORMAT_INVALID_MESSAGE_ID = "ALPHANUMBERID_ERROR";
